...
use Theanik\RepositoryService\Support\GenerateFile;
use Theanik\RepositoryService\Support\FileGenerator;
...
class CreateRepositoryCommand extends CommandGenerator
{
    ...
    protected function getTemplateContents()
    {
        ...
        return (new GenerateFile(__DIR__.'/stubs/repository.stub', [
